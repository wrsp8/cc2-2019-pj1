...
/** Representa una orden de pintura para los tipo Coupe. */
public class CoupeOrder extends PaintOrder {

    /** Campo random para generar el descuento en el constructor. */
     ...
     * @return nada
     * 
     * Este es el constructor de ordenes tipo Coupe 
     */
    public CoupeOrder(int number, String plate, int total, double time, double price) {
        super(number, plate, total, time);
        this.totalPrice = total * price;
        this.discount = rnd.nextInt(6) + 4;
